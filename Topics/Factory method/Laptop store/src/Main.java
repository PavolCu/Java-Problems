...
class LaptopStore extends LaptopFactory {
    ...
    Laptop createLaptop(String type) {
        switch (type) {
            case "13 inch":
                return new Laptop("13 inch Laptop"); /* write your code here */
            case "15 inch":
                return new Laptop("15 inch Laptop"); /* write your code here */
            case "17 inch":
                return new Laptop("17 inch Laptop"); /* write your code here */
            default:
                return null;
        }
    }
